...
import com.healthcard.backend.security.CustomUserDetailsService;
import com.healthcard.backend.security.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/pathologists/**").hasAnyRole("PATHOLOGIST", "ADMIN")
